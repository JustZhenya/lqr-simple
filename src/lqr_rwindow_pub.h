...
LQR_PUBLIC double lqr_rwindow_read(LqrReadingWindow *rwindow, int x, int y, int channel);

LQR_PUBLIC LqrEnergyReaderType lqr_rwindow_get_read_t(LqrReadingWindow *rwindow);
LQR_PUBLIC int lqr_rwindow_get_radius(LqrReadingWindow *rwindow);
LQR_PUBLIC int lqr_rwindow_get_channels(LqrReadingWindow *rwindow);
